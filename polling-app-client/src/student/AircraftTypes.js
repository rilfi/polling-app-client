...
import { getAllExpenseTypes, createAircraftType ,createExpenseCharge} from '../util/APIUtils';
...
import NewAircraftType from './NewAircraftType';
...
class AircraftTypes extends Component {
  ...
  componentDidMount() {
    ...
    render() {
        ...
        return (
            <div>
            <NewAircraftType addCar={this.addCar} fetchCars={this.fetchCars}/>            
...
export default withRouter(AircraftTypes);